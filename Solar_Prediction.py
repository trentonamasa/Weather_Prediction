...
def main():
	...
	# Start training
	model.fit(TrainingSetFeatures, TrainingSetLabels, n_epoch=3, batch_size=12, show_metric=True)
		
	'''Differnt activations and their accuracy:
	Softmax ~ 0.6015
	Linear ~ 0.1519
	Sigmoid ~ 0.5926
	ReLu ~ 0.3715
